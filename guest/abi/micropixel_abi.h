...
#define MICROPIXEL_GRAPHICS_INTERFACE_MINOR 7U
...
#define MICROPIXEL_GRAPHICS_MAX_SCENE_BYTES (128U * 1024U)
...
#define MICROPIXEL_GRAPHICS_MAX_BATCH_INSTANCES 1024U
#define MICROPIXEL_GRAPHICS_MAX_DRAW_OPERATIONS \
    (MICROPIXEL_GRAPHICS_MAX_SCENE_NODES + MICROPIXEL_GRAPHICS_MAX_BATCH_INSTANCES)
