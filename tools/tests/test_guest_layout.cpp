...
int main() {
...

    {
        ...
        auto result = ComputeFlexLayout(Rect{0, 0, 300, 80},
...

    {
        ...
        Check(output[0] == Rect{0, 0, 30, 60} && output[1] == Rect{36, 0, 30, 60} &&
                  output[2] == Rect{71, 0, 30, 60},
...

    {
        ...
        Check(output[0] == Rect{1, 2, 3, 4} && output[1] == Rect{5, 6, 7, 8},
              "failed layout must not modify output");
    }
