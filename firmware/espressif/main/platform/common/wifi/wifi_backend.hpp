#ifndef MICROPIXEL_PLATFORM_COMMON_WIFI_WIFI_BACKEND_HPP
#define MICROPIXEL_PLATFORM_COMMON_WIFI_WIFI_BACKEND_HPP
...
namespace micropixel::platform::common::wifi {

class WifiBackend final : public device::WifiBackend {
   public:
    explicit WifiBackend(radio::WifiRadio& radio) : radio_(radio) {}
