...
BackgroundExecutor::BackgroundExecutor(const char* task_name)
    ...
    if (queue_ == nullptr || stopped_ == nullptr ||
        xTaskCreatePinnedToCore(WorkerEntry, task_name, kTaskStackBytes, this, task_policy::kAssetWorkerPriority,
