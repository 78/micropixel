...
class NullAudioBackend final : public device::AudioBackend {
   public:
...
class NullHardwareInfoBackend final : public device::HardwareInfoBackend {
   public:
...
class NullPlatform final : public Platform {
   ...
   private:
    ...
    NullHardwareInfoBackend hardware_info_{};
