...
void SensorBackend::Initialize(i2c_master_bus_handle_t bus, I2cExecutor& i2c_executor) {
    bus_ = bus;
...
void SensorBackend::TimerExpired(void* context) {
    ...
    if (!sampler->owner->i2c_executor_->Post(I2cExecutor::Priority::kLow, SampleOnWorker, sampler)) {
