...
void SynthMixer::InitializeSineTable(int16_t (&table)[kSynthSineTableSize]) {
...
bool SynthMixer::ValidTone(const micropixel_audio_tone_t& tone) {
...
void SynthMixer::StartVoice(SynthVoice& voice, const micropixel_audio_tone_t& tone, uint32_t sample_rate) {
...
int32_t SynthMixer::NextSample(SynthVoice& voice, const int16_t (&sine_table)[kSynthSineTableSize]) {
