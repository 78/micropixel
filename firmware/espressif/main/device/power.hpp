...
// light-sleep cycle. Runtime and Guest services never access this backend.
class PowerBackend {
   public:
    virtual ~PowerBackend() = default;
    PowerBackend(const PowerBackend&) = delete;
    PowerBackend& operator=(const PowerBackend&) = delete;
