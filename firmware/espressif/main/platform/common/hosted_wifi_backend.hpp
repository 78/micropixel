#ifndef MICROPIXEL_PLATFORM_COMMON_HOSTED_WIFI_BACKEND_HPP
#define MICROPIXEL_PLATFORM_COMMON_HOSTED_WIFI_BACKEND_HPP
...
class HostedWifiBackend final : public device::WifiBackend {
   public:
    HostedWifiBackend() = default;
