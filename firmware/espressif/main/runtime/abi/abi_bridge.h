...
int32_t micropixel_runtime_service_call(wasm_exec_env_t exec_env, micropixel_service_handle_t service_handle,
...
int32_t micropixel_runtime_service_submit(wasm_exec_env_t exec_env, micropixel_service_handle_t service_handle,
