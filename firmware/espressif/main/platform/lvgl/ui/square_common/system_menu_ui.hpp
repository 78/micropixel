...
struct SystemMenuLayout final {
    ...
    SystemFontRole row_icon_font{SystemFontRole::kLarge};
    SystemFontRole row_name_font{SystemFontRole::kLarge};
    SystemFontRole row_detail_font{SystemFontRole::kMedium};
};
