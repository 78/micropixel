#ifndef MICROPIXEL_PLATFORM_INPUT_GT911_INPUT_HPP
#define MICROPIXEL_PLATFORM_INPUT_GT911_INPUT_HPP
...
class Gt911Input final : public device::Input {
   public:
    Gt911Input(int32_t width, int32_t height, gpio_num_t interrupt_pin);

    [[nodiscard]] esp_err_t Initialize(i2c_master_bus_handle_t i2c_bus, buses::I2cExecutor& i2c_executor);
