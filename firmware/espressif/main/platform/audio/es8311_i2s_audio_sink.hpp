...
struct Es8311I2sAudioConfig final {
...
// Shared ES8311 playback path. Boards own only the wiring, power policy and
// configuration; codec control is serialized through the common I2C executor.
class Es8311I2sAudioSink final : public AudioOutputPeripheral {
   public:
    explicit Es8311I2sAudioSink(Es8311I2sAudioConfig config) : config_(config) {}
