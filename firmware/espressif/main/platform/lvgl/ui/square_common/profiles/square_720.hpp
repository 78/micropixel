...
inline constexpr HallCardLayout kHallCardLayout{
    ...
    .stop_hit_padding = 10,
    .stop_icon_size = 18,
    .label_font = SystemFontRole::kMedium,
...
inline constexpr HallSceneLayout kHallSceneLayout{
    ...
    .header_button_font = SystemFontRole::kLarge,
    ...
    .status_bar =
        {
            ...
            .battery = {.x = 622, .y = 13},
            .battery_width = 30,
            .battery_percent = {.x = 657, .y = 18},
            .battery_percent_width = 38,
        },
};
...
inline constexpr SystemMenuLayout kSystemMenuLayout{
    ...
    .scrollbar_width = 5,
    .scrollbar_radius = 3,
    .row_icon_font = SystemFontRole::kLarge,
    .row_name_font = SystemFontRole::kLarge,
    .row_detail_font = SystemFontRole::kMedium,
};
...
inline constexpr SystemPageLayout kSystemPageLayout{
    ...
    .subtitle_font = SystemFontRole::kMedium,
    .heading_font = SystemFontRole::kLarge,
    .body_font = SystemFontRole::kMedium,
    .detail_font = SystemFontRole::kMedium,
};
