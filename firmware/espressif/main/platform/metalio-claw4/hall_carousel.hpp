#ifndef MICROPIXEL_PLATFORM_METALIO_CLAW4_HALL_CAROUSEL_HPP
#define MICROPIXEL_PLATFORM_METALIO_CLAW4_HALL_CAROUSEL_HPP
...
struct HallCarousel final {
    static constexpr int32_t kLeft = 40;
    static constexpr int32_t kTop = 184;
    static constexpr int32_t kViewportWidth = 680;
    static constexpr int32_t kCardWidth = 202;
    static constexpr int32_t kCardHeight = 254;
    static constexpr int32_t kCardGap = 17;
