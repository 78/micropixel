...
void SystemMenuUi::DrawRow(lv_obj_t* parent, size_t index, host_ui::SystemMenuItem item, const char* icon_text,
    ...
    lv_obj_t* icon = CreateLabel(panel, icon_text, BuiltinLatinFont(layout.row_icon_font), icon_color);
    ...
    lv_obj_t* name_label = CreateLabel(text_column, name, BuiltinLatinFont(layout.row_name_font), 0xf2f7ffU);
    lv_obj_set_width(name_label, LV_PCT(100));
    lv_label_set_long_mode(name_label, LV_LABEL_LONG_DOT);
    lv_obj_t* detail_label = CreateLabel(text_column, detail, BuiltinLatinFont(layout.row_detail_font), 0x91a4bdU);
    ...
    lv_obj_t* chevron = CreateLabel(panel, LV_SYMBOL_RIGHT, BuiltinLatinFont(layout.row_name_font), 0xf2f7ffU);
...
std::expected<void, host_ui::SystemUiError> SystemMenuUi::ShowLocked(lv_obj_t* root, lv_display_t* display,
    ...
    lv_obj_t* title = CreateLabel(header_text, strings.Get(host_strings::Id::kSystemSettingsTitle),
                                  BuiltinLatinFont(SystemFontRole::kTitle), 0xf2f7ffU);
    lv_obj_set_width(title, LV_PCT(100));
    lv_label_set_long_mode(title, LV_LABEL_LONG_DOT);
    lv_obj_t* subtitle = CreateLabel(header_text, strings.Get(host_strings::Id::kSystemSettingsSubtitle),
                                     BuiltinLatinFont(SystemFontRole::kMedium), 0x91a4bdU);
