...
lv_obj_t* CreateDefaultKeyboard(lv_obj_t* parent, lv_obj_t* textarea, SystemFontRole font) {
    ...
    lv_obj_set_style_text_font(keyboard, BuiltinLatinFont(font), LV_PART_ITEMS);
    ConfigureDefaultKeyboardButtons(keyboard);
    ...
    lv_obj_set_style_border_color(preview, lv_color_hex(0x69a7ffU), 0);
    lv_obj_set_style_bg_color(preview, lv_color_hex(0x16263aU), 0);
    ...
    lv_obj_set_style_text_font(preview_label, BuiltinLatinFont(SystemFontRole::kTitle), 0);
    lv_obj_set_style_text_color(preview_label, lv_color_hex(0xf2f7ffU), 0);
