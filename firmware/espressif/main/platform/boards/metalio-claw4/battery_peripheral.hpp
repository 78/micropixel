#ifndef MICROPIXEL_PLATFORM_METALIO_CLAW4_BATTERY_PERIPHERAL_HPP
#define MICROPIXEL_PLATFORM_METALIO_CLAW4_BATTERY_PERIPHERAL_HPP
...
class BatteryPeripheral final : public device::Battery {
   public:
    ...
    void Initialize(i2c_master_bus_handle_t bus, i2c_master_dev_handle_t io_expander, buses::I2cExecutor& i2c_executor);
